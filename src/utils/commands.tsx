      ...
      return (
        <div>
          ...
          <span className="text-blue-300 ml-3">
            <a href="https://bvcoend.ac.in/" target="_blank" rel="noreferrer" >Bharati Vidyapeeth College of Engineering</a>
          </span>{" "}
          ...
          <span className="text-blue-400"><a href="https://www.chess.com/member/normallifesuck" target="_blank" rel="noreferrer">Chess.com</a></span> 🤘 <br />
        </div>
      );
    case "socials":
      return (
        <div>
          ...
          <span className="text-blue-300 ml-3">
            <a href="https://github.com/Abhinavks1405" target="_blank" rel="noreferrer">Github</a>
          </span> - Here you can find all my projects and contributions. <br />
          <span className="text-blue-300 ml-3">
            <a href="https://www.linkedin.com/in/abhinavkumarsingh1405" target="_blank" rel="noreferrer">LinkedIn</a>
